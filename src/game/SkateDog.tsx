...
export const SkateDog = forwardRef<Group, DogProps>(function SkateDog(
  { fur = "#e8b86d", accent = "#ff8fab", ghost = false, frustumCulled = false },
  ref,
) {
  const groupRef = useRef<Group>(null);
  // Mount-only materials; prop changes apply via layout effect below.
  // biome-ignore lint/correctness/useExhaustiveDependencies: intentional mount-once
  const mats = useMemo(() => createDogMaterials(fur, accent, ghost), []);
